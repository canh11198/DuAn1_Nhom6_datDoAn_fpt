...
public class ChiTiet_MA_MainActivity extends AppCompatActivity {
    Button btn_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chi_tiet_ma_main);
        ...
        binhLuan_adapter=new BinhLuan_Adapter(ChiTiet_MA_MainActivity.this,list);
            ...
            public void onClick(View v) {
                ...
                if (!gioHang_dao.FoodExists(gio_hang.getIdFood(), gio_hang.getUsername())) {
                    ...
                    if (gioHang_dao.insert(gio_hang) > 0) {
                        ...
                        Toast.makeText(ChiTiet_MA_MainActivity.this, "Thêm giỏ hanàng thành công", Toast.LENGTH_SHORT).show();
                        // Ví dụ: có thể đóng activity hoặc cập nhật giao diện nếu cần
                    } else {
                        // Thông báo thất bại nếu không thể thêm vào cơ sở dữ liệu
                        Toast.makeText(ChiTiet_MA_MainActivity.this, "Không thêm vào giỏ hàng", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // Thông báo nếu món ăn đã được chọn trước đó
                    Toast.makeText(ChiTiet_MA_MainActivity.this, "Món ăn đã được chọn", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
