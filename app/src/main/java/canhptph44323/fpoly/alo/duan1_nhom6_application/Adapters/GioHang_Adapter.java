...
public class GioHang_Adapter extends RecyclerView.Adapter<GioHang_Adapter.ViewHolder> {
    ...
    public GioHang_Adapter(Context context, ArrayList<Gio_Hang> list, GioHang_Dao gioHang_dao) {
        ...
        this.food_dao = new Food_Dao(context);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Foods food = food_dao.getById(gio_hang.getIdFood());
        ...
        holder.tv_price.setText(String.valueOf(food.getPrice() * gio_hang.getQuanti()) + " VND");
        ...
        holder.btn_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.tv_price.setText(String.valueOf(food.getPrice() * quatity) + "VND");
                gio_hang.setQuanti(quatity);
                gio_hang.setSum(food.getPrice() * quatity);
        ...
        holder.btn_down.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity >1){
                    ...
                    holder.tv_price.setText(String.valueOf(food.getPrice() * quantity) + "VND");
                    gio_hang.setQuanti(quantity);
                    gio_hang.setSum(food.getPrice() * quantity);
                    gioHang_dao.updateSum(gio_hang);
